...
function appendSGF(sgf_pt){
  sgf_file += sgf_pt;
  fs.writeFile(__dirname + '/../public/sgf/game.sgf', global.sgf_file, function(err){
    if(err) throw err;
  });
}
...
exports.move = function(coord){
  ...
  //reversed because we have it after round switch and boardupdate
